...
** 問題
*** 計算結果を終了ステータスとして返すプログラム(prac02.c)
...
*** 整数の和を終了ステータスとして返すプログラム(returnWa1to10.c)

1から10までの整数の和を終了ステータスとして返すプログラムを作成しなさい。
現状、変数、条件文、繰り返し、再帰などプログラミングに関することを何も説明していないが、
プログラムを電卓の延長として考えてみよ。足し算を行わせることができれば実装できるはずである。
