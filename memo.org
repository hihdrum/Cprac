...
最初に書くプログラムの定番であるハローワールドを作成してみましょう。
適当なテキストエディタを使ってhelloworld.cを作成して下さい。中身は以下のとおりです。

#+name: helloworld
#+caption: 最初のソースコード helloworld.c
#+begin_src C :exports both :cache yes :results output :tangle helloworld.c
#include <stdio.h>
...
#+RESULTS[ab8f40efed30bfd8dee783569b3a21849bbb4de2]: helloworld
: Hello, world!
...
その場合は、[[helloworld.c]]のソースコードと自身で入力したソースコードをよく比較してみてください。
