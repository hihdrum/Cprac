...
**** float型の引数を受け取り、その値の2乗を返す関数square_floatを作成し、実際に使用してみよ。(square.c)
**** float型の引数を受け取り、その値の3乗を返す関数cube_floatを作成し、実際に使用してみよ。(square.c)
作成にあたり、square_floatを利用せよ。

**** float型の引数を受け取り、その値の4乗を返す関数quad_floatを作成し、実際に使用してみよ。(square.c)
作成にあたり、square_floatを利用せよ。
