...
#+name: 順次実行
#+begin_src C :results output :tangle junn.c :cache yes
#include <stdio.h>
...
#+RESULTS[13281394a091cc7c33555bee391594774d871911]: 順次実行
: 最初
: 次
...
** 問題
  ...
  8. break, continue の使用例を考えてみなさい。
  9. 2重ループからbreakする例を考えてみなさい。
  10. gotoを利用してみなさい。
  11. 偶数の数列があるとする。偶数nからmまでの和を求めよ。
      ただし、n<mとする。
  12. 奇数の数列があるとする。奇数nからmまでの和を求めよ。
      ただし、n<mとする。
  13. 3の倍数の数列があるとする。nからmまでの和を求めよ。
      ただし、n<mとする。
  14. 以下のようなデータが提供された。
      #+begin_src C
